...
export default function ZimbabweArticle() {
  return (
		<article className="prose prose-lg max-w-none prose-headings:text-[#071126] prose-p:text-slate-700">
			...
			<h2>
				<strong>Hidden Gems You Shouldn't Miss</strong>
			</h2>

			<h3>1. Great Zimbabwe National Monument</h3>

			<p>
				One of Africa's most important archaeological sites, Great Zimbabwe is a
				UNESCO World Heritage Site and the largest ancient stone structure in
			...
			<p>
				...
				wilderness destinations. Known for walking safaris, canoe adventures and
				incredible wildlife encounters, it offers a more intimate safari
			...
			<p>
				Often overlooked by international visitors, Zimbabwe's Eastern Highlands
				feature rolling mountains, waterfalls, forests and tea plantations.
				Destinations such as Nyanga, Vumba and Chimanimani are perfect for
			...
			<p>
				...
				rhino tracking experiences, Matobo National Park combines natural beauty
				with significant cultural history.
			</p>
			...
			<p>
				...
				sunsets, fishing excursions, houseboat adventures and abundant wildlife
				along its shoreline.
			</p>
			...
			<table className="w-full border-collapse border border-slate-400">
				...
				<tbody>
					<tr className="hover:bg-slate-50">
						<td className="border border-slate-300 px-6 py-3">May – August</td>
			...
			<p>
				For most travellers, the dry season between May and October provides the
				best overall experience, especially for wildlife viewing.
			</p>
			...
			<h2>
				<strong>Where Should You Stay?</strong>
			</h2>
			...
			<h2>
				<strong>Why Zimbabwe Deserves a Place on Your Bucket List</strong>
			</h2>
			...
			<p>
				Whether you're exploring Victoria Falls, tracking wildlife in Mana Pools
				or discovering ancient history at Great Zimbabwe, you'll find a
