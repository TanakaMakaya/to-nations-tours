...
export default function SafariPackingArticle() {
  return (
    <article className="prose prose-lg max-w-none prose-headings:text-[#071126] prose-p:text-slate-700">
      ...
      <Image
        src="/images/journal/packing-hero.webp"
      ...
      <h2>Safari Clothing Essentials</h2>
      ...
      <Image
        src="/images/journal/safari-gear.webp"
      ...
      <h2>Bring a Camera (or Smartphone)</h2>

      <p>
        Safaris are filled with unforgettable moments, from a leopard resting
        in a tree to a herd of elephants crossing the road. A camera with a
        zoom lens is ideal, but modern smartphones can also capture incredible
        photographs. 
      </p>
      ...
      <h2>Be Ready for Changing Weather</h2>

      <p>
        African weather can change quickly. Early morning game drives are often
        cool, while afternoons can become quite warm. The easiest solution is
        to wear layers that you can add or remove throughout the day. 
      </p>
      ...
      <h2>Ready for Your African Safari?</h2>
      ...
      <div className="not-prose mt-12 rounded-3xl bg-[#071126] p-8 text-center text-white">
        ...
        <p className="mb-6 text-slate-300">
          Let us help you create a personalised African safari experience
