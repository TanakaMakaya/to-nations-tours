...
export default function Hero() {
  return (
    <section className="relative mt-20 min-h-[calc(100svh-5rem)] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-5rem)] w-full max-w-7xl items-end px-5 pb-12 sm:px-6 sm:pb-16 md:pb-20 lg:pb-24">
        <div className="w-full max-w-3xl text-white">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:flex sm:gap-4">
            <Link
              href="/packages"
              className="flex min-h-14 items-center justify-center rounded-full border border-white px-4 py-3 text-center text-sm font-bold text-white transition hover:bg-white hover:text-[#12345a] sm:px-8 sm:text-base"
            >
              View Packages
            </Link>
            ...
            <Link
              href="/contact"
              className="flex min-h-14 items-center justify-center rounded-full border border-white px-4 py-3 text-center text-sm font-bold text-white transition hover:bg-white/10 sm:px-8 sm:text-base"
            >
              Plan My Journey
            </Link>
          </div>
